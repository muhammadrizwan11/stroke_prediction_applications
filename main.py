...
# correct_username = "Gravis"
# correct_password = "stroke18"
...
#             st.sidebar.success('Login successful! Redirecting to the main application...')
#             return True
#         else:
...
# def main():
#     if login_page():
#         st.title('Gravis - Stroke Prediction')
#         # Input fields
#         st.write('Enter Patient Information:')
#         gender = st.radio('Gender:', ['Male', 'Female'])
#         age = st.slider('Age:', min_value=0, max_value=100, value=50, step=1)
